...
urlpatterns = [
    ...
    path('admin-algorithm-multinb', admin_views.multinb, name= 'multinb'),
    path('admin-algorithm-adaboost', admin_views.adaboost, name= 'adaboost'),
    path('ada-run/<int:id>', admin_views.ada_run, name='ada_run'),
    path('lr-run/<int:id>', admin_views.lr_run, name='lr_run'),
    path('mnb-run/<int:id>', admin_views.mnb_run, name='mnb_run'),
